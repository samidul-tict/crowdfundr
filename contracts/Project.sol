...
contract Project {
    ...
    uint256 public currentProjBalance;
    ...
    mapping (uint256 => address) public badgeByDonor;
    ...
    function contribute() public payable returns(uint256 _tokenId) {
        ...
        currentProjBalance = totalFundRaised;
    ...
    function createSpendingRequest(
        ...
        spendingRequest.startDate = block.timestamp;
    ...
    function payMoney(uint256 _requestID) public onlyAdmin() isSRReady(_requestID) {
        ...
        SpendingRequests[_requestID].endDate = block.timestamp;
